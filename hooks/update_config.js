...
module.exports = function(context) {
    ...
    try {
        ...
        ConfigParser = context.requireCordovaModule("cordova-common")
            .ConfigParser;
        ...
        XmlHelpers = context.requireCordovaModule(
            "cordova-lib/src/util/xml-helpers"
        );
    }
    ...
    var xwalkVariables = {},
        ...
        pluginConfigurationFile = path.join(
